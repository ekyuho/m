...
# a1. 웹 개발을 위한 Dev Ops Docker 개발 환경 구성 (50시간)
## 활용자료:
...
# a2. 리눅스 OS 기반 Auto Scaling 시스템 구축 프로젝트 (50시간)
## 활용자료:
네이버클라우드 인프라 교육 및 학습 데이터
## 습득직무역량:
1. 로드밸런스 설정 및 활용
...
# a3. VS Code를 활용한 페어코딩 실습 환경 구축 프로젝트  (50시간)
## 활용자료:
네이버클라우드 인프라 교육 및 학습 데이터 
## 습득직무역량:
1. 페어코딩 구축 환경 이해
...
# a9. 클라우드 ML 활용 이상 감지 시스템 구축 (200시간)
## 활용자료:
네이버클라우드 기술 문서 및 활용 사례집
AI 관련 유사 프로젝트 구축 활용 자료(PBT 시스템 제공)
네이버클라우드 기술 문서 및 활용 사례집
...
# a10. 소상공인을 위한 AI 전화 주문 시스템 구축 (200시간)
## 활용자료:
네이버클라우드 기술 문서 및 활용 사례집
AI 관련 유사 프로젝트 구축 활용 자료(PBT 시스템 제공)
네이버클라우드 기술 문서 및 활용 사례집
