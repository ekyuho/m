...
|구분|코드|제목|시간|
|--|--|--|--|
|클라우드 인프라 구축 프로젝트|a1|웹 개발을 위한 Dev Ops Docker 개발 환경 구성|50|
|클라우드 인프라 구축 프로젝트|a2|리눅스 OS 기반 Auto Scaling 시스템 구축 프로젝트|50|
|클라우드 인프라 구축 프로젝트|a3|VS Code를 활용한 페어코딩 실습 환경 구축 프로젝트 |50|
|클라우드 기반 웹/모바일 프로젝트|a4|미술품 경매 사이트 개발|120|
|클라우드 기반 웹/모바일 프로젝트|a5|SNS 알림 시스템 구축 프로젝트|120|
|클라우드 기반 웹/모바일 프로젝트|a6|URL 단축기 설계 시스템 개발|120|
|클라우드 기반 AI 융복합 프로젝트|a7|동시통역 프로그램 개발|200|
|클라우드 기반 AI 융복합 프로젝트|a8|얼굴인식 출입 인증 시스템 개발|200|
|클라우드 기반 AI 융복합 프로젝트|a9|클라우드 ML 활용 이상 감지 시스템 구축|200|
|클라우드 기반 AI 융복합 프로젝트|a10|소상공인을 위한 AI 전화 주문 시스템 구축|200|
# 프로젝트코드: a1
|항목|내용|
|--|--|
|구분|클라우드 인프라 구축 프로젝트|
